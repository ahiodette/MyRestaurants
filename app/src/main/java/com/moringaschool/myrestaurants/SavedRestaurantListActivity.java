...
import com.moringaschool.myrestaurants.ui.Constants;
import com.moringaschool.myrestaurants.ui.FirebaseRestaurantViewHolder;
    ...
    private void setUpFirebaseAdapter(){
        ...
        mFirebaseAdapter = new FirebaseRecyclerAdapter<Restaurant, FirebaseRestaurantViewHolder>(options) {
            ...
            public FirebaseRestaurantViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                View views = LayoutInflater.from(parent.getContext()).inflate(R.layout.restaurant_list_item, parent, false);
                return new FirebaseRestaurantViewHolder(views);
            }
        };
